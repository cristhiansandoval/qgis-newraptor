...
/***************************************************************************
 NewRaptor
                                 A QGIS plugin
 Agrega un nuevo nido de aves rapaces, crea una zona de influencia y una tabla de impacto
 Generated by Plugin Builder: http://g-sherman.github.io/Qgis-Plugin-Builder/
                              -------------------
        begin                : 2023-01-25
        git sha              : $Format:%H$
        copyright            : (C) 2023 by SyK
...
class NewRaptor:
    ...
    def run(self):
        ...
        if missing_layers:
            msg = "Las siguientes capas estan perdidas para este proyecto \n"
        ...
        if result:
            ...
            QMessageBox.information(self.dlg, "Message", "Nuevo Nest ID: {}\n\nLatitud: {}\nLongitud: {}\nEspecies: {}\nBuffer: {}\nEstado: {}\nUlt Encuesta: {}".format(valNestID, valLat, valLng, valSpecies, valBuffer, valStatus, valLast))
            ...
            dlgTable = DlgTable()
            # Encuentra proyectos lineales que se verán afectados e infórmelos en la tabla
            ...
            for linear in linears:
                ...
                if valDistance < valBuffer:
                    # Rellena tabla con datos lineales
            ...
            QMessageBox.information(self.dlg, "Message", "Deberia ejecutar solo con Cancel apretado")
